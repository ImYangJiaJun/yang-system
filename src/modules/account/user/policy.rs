...
pub(super) const USERNAME_MAX_LENGTH: usize = 64;
pub(super) const USERNAME_PATTERN: &str = "^[A-Za-z0-9_-]+$";
pub(super) const PASSWORD_MIN_LENGTH: usize = 10;
pub(super) const PASSWORD_MAX_LENGTH: usize = 128;

pub(super) fn normalize_username(username: &str) -> Result<String, BaseError> {
