...
use super::super::{ACTIVE_STATUS, IS_ADMIN, NAME, POSITION, STATUS, SYSTEM_ROLE, USER_ID};
...
pub(in crate::addon::admin::user) struct AdminRepository {
    accounts: TableDefinition,
}

impl AdminRepository {
    pub(in crate::addon::admin::user) fn new(accounts: TableDefinition) -> Self {
        Self { accounts }
    }
