...
pub(in crate::addon::org::access) struct TenantSummary {
    pub(super) id: i64,
    pub(super) name: String,
    pub(super) code: String,
}

pub(in crate::addon::org::access) struct TenantService {
    repository: TenantRepository,
}

impl TenantService {
    pub(in crate::addon::org::access) fn new(repository: TenantRepository) -> Self {
        Self { repository }
    }

    pub(in crate::addon::org::access) async fn list(
        &self,
        ctx: &ActionContext,
        page: Option<i64>,
        limit: Option<i64>,
    ...
    pub(in crate::addon::org::access) async fn create(
        &self,
        ctx: &ActionContext,
        name: &str,
        code: &str,
